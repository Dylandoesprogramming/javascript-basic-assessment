console.log("I am starting now at 1:38pm dallas time");
...
function removeItem(strArr,str){
	strArr = strArr.join(" ");
	for(var i = 0; i < strArr.length; i++){
			strArr = strArr.replace(str,"");
	}
	strArr = strArr.split(" ");
...
// repeats strings. example 4->8, 2.5->5, 'Awesome'->'AwesomeAwesome'
	...
	function doubleTheFun(doubleMe){
		if(Number(doubleMe) > 0){
			return Number(doubleMe) + Number(doubleMe);
		}
		else{
